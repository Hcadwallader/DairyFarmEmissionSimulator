...
let CalculateEmissionsForInputtedFarm = (req, res) => {
    ...
    if(averageEmissions === undefined || averageEmissions === {} ) {
        console.error("Failed to read averages out of cache - has a source file been uploaded yet?")
    ...
    farmEmissions["scope1"] = averageEmissions["scope1AveragePerAcre"] * req.body.size;
    farmEmissions["scope2"] = averageEmissions["scope2AveragePerUnit"] * req.body.milkMachines;
    farmEmissions["scope3"] = averageEmissions["scope3AveragePerCow"] * req.body.numberOfCows;

    farmEmissions["totalEmissions"] = farmEmissions["scope1"] + farmEmissions["scope2"] + farmEmissions["scope3"];
    farmEmissions["perLiterOfMilk"] = farmEmissions["totalEmissions"] / req.body.quantityOfMilk;
